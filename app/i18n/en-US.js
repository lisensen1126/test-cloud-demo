export default {
    ...
    organization: {
        ...
        integration: {
            ...
            use_tip_two:
                'After saving the Basic Auth account information, you need to manually associate the ID/key in the MeterSphere project',
    ...
    api_test: {
        ...
        request: {
            ...
            url_description: 'etc: fit2cloud.com',
        ...
        api_import: {
            ...
            idl_tip: 'Only IDL Collection V2.1 json files are supported',
        ...
        home_page: {
            title: 'Interface Test Overview',
            unit_of_measurement: '',
            unit_of_count: '',
            unit_of_times: 'times',
            interfaceCase: 'Interface Case',
            scenarioCase: 'scenario Case',
            performanceCase: 'Performance Case',
            coverage: 'Coverage',
            notcovered: 'Not covered',
            covered: 'Covered',
            用例维护人分布: 'Case Maintainer Distribution',
            功能用例数: 'Number of functional cases',
            关联用例数: 'Number of associated cases',
            formula: {
            ...
            test_case_details_card: {
                ...
                this_week_execute_sm: 'Executed {0} this week',
                executed_sm: 'Executed {0} in history',
            },
            ...
            schedule_task_details_card: {
                ...
                this_week_execute: 'Executed {0} this week',
                executed: 'Executed {0} in history',
                this_week_add_sm: 'Added {0} this week',
                this_week_execute_sm: 'Executed {0} this week',
                executed_sm: 'Executed {0} in history',
            },
            failed_case_list: {
    ...
    test_track: {
        遗留缺陷统计: 'Statistics of remaining defects',
        占比: 'Percentage',
        ...
        case: {
            count: 'Statistics of the number of use cases',
            percent: 'Review rate',
            noreview: 'Not reviewed',
            nopass: 'No pass',
            passed: 'Passed',
            associateCount: 'Statistics on the number of associated use cases',
            ...
            tree_8_level: 'The maximum depth of the module tree is 8 levels',
