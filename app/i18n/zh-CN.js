export default {
    commons: {
        ...
        search_by_id_name_tag: '根据ID/名称/标签搜索',
    ...
    api_test: {
        ...
        request: {
            ...
            url_description: '例如：fit2cloud.com',
        ...
        api_import: {
            ...
            idl_tip: '只支持 IDL Collection v2.1 格式的 json 文件',
        ...
        home_page: {
            ...
            test_case_details_card: {
                ...
                this_week_execute_sm: '本周执行: {0}次',
                executed_sm: '历史总执行: {0}次',
            },
