    ...
    <div>
            ...
            <el-col :span="10">
                <el-form :inline="true">
                    ...
                    <el-form-item>
                        ...
                        >
                            <el-option
                                v-for="op in granularityData"
                                :key="op.granularity"
                                :label="op.granularity"
                                :value="op.granularity"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                </el-form>
        ...
        <el-col :span="24">
            ...
            >
                ...
                <el-table-column align="center" prop="port" label="Port"></el-table-column>
