<template>
    <ms-container>
        <ms-main-container>
            <div class="title-box">
                <el-button class="back-btn" icon="el-icon-arrow-left" @click="backBtn"></el-button
                >丨
                <span class="title-box-txt">模拟性能测试计划</span>
            </div>
            <el-card v-loading="result.loading">
                <el-row>
                    ...
                    <el-col :span="12" :offset="2" class="buttonBox">
                        <el-button
                            :disabled="isReadOnly"
                            type="primary"
                            size="mini"
                        ...
                        <el-button :disabled="isReadOnly" type="warning" size="mini" @click="cancel"
                            >{{ $t('commons.cancel') }}
                        </el-button>
...
export default {
    ...
    methods: {
        ...
        getSaveOption() {
            ...
            // 项目名称
            this.test.cName = localStorage.getItem(PROJECT_NAME)
            // file属性不需要json化
...
.buttonBox .el-button--primary:hover {
    background-color: #606c80;
    border: 1px solid #606c80;
}
.buttonBox .el-button--warning {
    color: #202d40;
    background-color: #fff;
    border: 1px solid #dadfe6;
}
.buttonBox .el-button--warning:hover {
