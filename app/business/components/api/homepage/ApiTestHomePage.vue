    ...
    <ms-container>
      ...
      <div style="float: right">
        ...
        <ms-main-container v-loading="result.loading">
            <div class="header-tit">{{ $t('api_test.home_page.title') }}</div>
            ...
            <el-row :gutter="10">
                ...
                <el-col :span="6">
                    <ms-test-case-info-card
                        @redirectPage="redirectPage"
                        :test-case-count-data="testCaseCountData"
                    />
                </el-col>
                <el-col :span="6">
                    <ms-scene-info-card
                        @redirectPage="redirectPage"
                        :scene-count-data="sceneCountData"
