<template>
  <el-card class="table-card" v-loading="result.loading" body-style="padding:10px;">
    ...
    <el-container style="height: 130px;">
      <el-aside width="120px">
        <div class="data-picture">
          <percentage-circle
            :value="testCaseCountData.allApiDataCountNumber"
          />
        </div>
      </el-aside>
      <el-main style="padding-left: 0px;padding-right: 0px">
        <div style="width: 200px;margin:0 auto">
          <el-row type="flex" align="center" class="hidden-lg-and-down">
            <el-col style="padding: 5px;border-right-style: solid;border-right-width: 1px;border-right-color: #ECEEF4;">
          ...
          <el-row type="flex" align="right" style="margin-left: 20px" class="hidden-xl-only">
            <el-col style="padding: 5px;border-right-style: solid;border-right-width: 1px;border-right-color: #ECEEF4;">
              <div class="count-info-div" v-html="testCaseCountData.httpCountStr"></div>
            </el-col>
            <el-col style="padding: 5px;border-right-style: solid;border-right-width: 1px;border-right-color: #ECEEF4;">
    ...
    <el-container class="detail-container">
      <el-header style="height:20px;padding: 0px;margin-bottom: 10px;">
        ...
        <el-row :gutter="20" class="hidden-xl-only">
          <el-col  :span="12">
            <div class="count-info-div info-item">
          ...
          <el-col :span="12" >
            <div class="count-info-div info-item" v-html="$t('api_test.home_page.test_case_details_card.this_week_execute_sm',[testCaseCountData.thisWeekExecutedCount])"></div>
          </el-col>
          <el-col :span="12" >
            <div class="count-info-div info-item" v-html="$t('api_test.home_page.test_case_details_card.executed_sm',[testCaseCountData.executedCount])"></div>
          </el-col>
        </el-row>
      </el-header>
      <el-main style="padding: 5px;margin-top: 10px">
        <el-container>
          ...
          <el-main style="padding: 5px">
            <el-card shadow="never" body-style="padding-left:5px;padding-right:5px;background-color:rgba(247,248,250, 1)">
              <main>
                <el-row>
                  <el-col>
                    <span class="spot-red"></span>
                  ...
                  <el-col style=" height: 25px;margin-top: 3px;">
                  </el-col>
                  <el-col style="margin-top: 5px;">
                    <span class="spot-green"></span>
