      ...
      <el-form-item :label="$t('api_test.value')" prop="value">
        <el-col class="item">
          <el-autocomplete
            ...
            <i slot="suffix" class="el-input__icon el-icon-edit pointer" style="color:#3385ff;" @click="advanced"></i>
          </el-autocomplete>
        </el-col>
      </el-form-item>
    </el-form>
    <!-- 值-弹框 -->
    <ms-api-variable-advance ref="variableAdvance" v-bind="{...variableOptions}" />
  </div>
</template>
