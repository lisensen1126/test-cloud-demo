                            ...
                            <div style="float: right">
                                ...
                                >
                                    ...
                                    <el-dropdown-menu slot="dropdown">
                                        ...
                                        <el-dropdown-item command="COUNTER">{{
                        ...
                        <el-row>
                            ...
                            <el-col :span="12">
                                <ms-edit-constant
                                    ...
                                    :variable-options="{showModal: false, top: '7vh'}"
                                />
                                <ms-edit-counter
                ...
                <el-tab-pane :label="$t('api_test.scenario.headers')" name="headers">
                    ...
                    >
                        <span
                            ...
                            <div
                                class="el-step__icon is-text ms-api-col ms-variable-header"
                    ...
                    <el-row style="text-align:right;">
                        <el-link
                            ...
                            @click="batchAdd"
                            style="margin:0 45px 10px 0;color: #3385ff"
                            :disabled="disabled"
                        >
                            {{ $t('commons.batch_add') }}
                        </el-link>
