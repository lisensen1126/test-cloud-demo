  ...
  data() {
    return {
      ...
      tableUsualOperatorButtons: [
        {tip: this.$t('api_test.automation.execute'), icon: '', exec: this.runApi, type: "text", tooltipDisabled: true,},
        {tip: this.$t('commons.edit'), icon: '', exec: this.editApi, type: "text", tooltipDisabled: true,},
        {tip: "CASE", exec: this.handleTestCase, icon: '', type: "text", tooltipDisabled: true,},
        {tip: this.$t('commons.delete'), icon: '', exec: this.handleDelete, type: "text", tooltipDisabled: true, style: { color: '#E7363B' }},
      ],
