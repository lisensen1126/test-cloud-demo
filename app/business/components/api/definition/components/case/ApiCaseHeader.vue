            ...
            <el-row>
                ...
                <el-col :span="3">
                    <div>
                        <el-select
                            size="small"
                            :placeholder="$t('api_test.definition.request.grade_order_asc')"
                ...
                <el-col :span="4">
                    <div class="ms-api-header-select" style="margin-right: 20px">
                        <el-row>
                            ...
                            <el-col :span="12">
                                <el-link type="primary" style="margin-left: 5px" @click="open">{{
                ...
                <el-col :span="1" v-if="!(isReadOnly || isCaseEdit)">
                    <el-button
                        ...
                        v-tester
                        class="addCaseBtn"
                        >+{{ $t('api_test.definition.request.case') }}</el-button
                    >
                </el-col>
            </el-row>
        </el-card>
