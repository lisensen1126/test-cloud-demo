<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <div>
    <el-row>
      <el-col :span="21">
        <!-- HTTP 请求参数 -->
        <div style="border:1px #DCDFE6 solid; height: 100%;width: 100%" v-loading="isReloadData">
          <el-tabs v-model="activeName" class="request-tabs">
            ...
            <el-tab-pane :label="$t('api_test.request.headers')" name="headers">
              ...
              <el-row>
                <el-link class="ms-el-link" @click="batchAdd" style="color: #3385ff"> {{$t("commons.batch_add")}}</el-link>
              </el-row>
