<template>
    <el-dialog
        ...
        :title="$t('api_test.api_import.title')"
        width="30%"
    ...
    >
        <div class="header-bar">
            ...
            <div class="operate-button">
                <el-button class="save-button" type="primary-blue" plain @click="save">
                    {{ $t('commons.save') }}
                </el-button>
                <el-button class="cancel-button" plain @click="visible = false">
                    {{ $t('commons.cancel') }}
                </el-button>
            </div>
        </div>
            ...
            <el-row>
                <el-col :span="11">
                    ...
                    <el-form-item v-if="showTemplate">
                        <el-link type="primary" class="download-template" @click="downloadTemplate"
                ...
                <el-col :span="12" v-show="isSwagger2 && swaggerUrlEnable" style="margin-top: 40px">
                    ...
                    <el-form-item>
                        <el-switch v-model="swaggerSynchronization" @click.native="scheduleEdit">
                        </el-switch>
                        <span
                            style="color: #007eff;cursor: pointer;font-weight: bold;margin-left: 10px"
                            @click="scheduleEditByText"
                            >{{ $t('api_test.api_import.timing_synchronization') }}</span
                        >
                    </el-form-item>
                </el-col>
                <el-col
...
export default {
    ...
    data() {
        return {
            ...
            idlPlanform: {
                name: 'IDL',
                value: 'IDL',
                tip: this.$t('api_test.api_import.idl_tip'),
                exportTip: this.$t('api_test.api_import.post_export_tip'),
                suffixes: new Set(['json']),
            },
            swaggerPlanform: {
    ...
    created() {
        ...
        this.platforms.push(this.idlPlanform);
    ...
    watch: {
        ...
        propotal() {
            ...
            let idlPlanformIndex = this.platforms.indexOf(this.idlPlanform);
            if (postmanIndex >= 0) {
            ...
            if (idlPlanformIndex >= 0) {
                this.platforms.splice(this.platforms.indexOf(this.idlPlanform), 1);
            }
    ...
    methods: {
        ...
        buildParam() {
            ...
            param.platform =
                this.selectedPlatformValue === 'IDL' ? 'Postman' : this.selectedPlatformValue;
