<template>
    <div>
        <el-button class="add-btn" type="primary" size="mini" @click="appIssue">{{
      ...
      <i class="el-icon-info"/>
        ...
        <ms-table
            ...
            @refresh="getIssues"
        >
            <ms-table-column :label="$t('test_track.issue.id')" prop="id"> </ms-table-column>

            <ms-table-column :label="$t('test_track.issue.title')" prop="title"> </ms-table-column>

            <ms-table-column :label="$t('test_track.issue.status')" prop="status">
                ...
                <template v-slot:default="scope">
                    ...
                    >
                        <el-button
                            ...
                            size="mini"
                            circle
                            v-if="scope.row.platform === 'Local'"
                            @click="closeIssue(scope.row)"
                        />
                    </el-tooltip>
                    <el-tooltip
                        :content="$t('test_track.issue.delete')"
                        placement="top"
                        :enterable="false"
                    >
                        <el-button
