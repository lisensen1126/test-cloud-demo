            ...
            >
                ...
                <el-row class="import-row">
                    <el-card :body-style="{ padding: '0px' }">
                        <img :src="xMindIcon" class="testcase-import-img" />
                    </el-card>
                </el-row>
                <el-row class="import-row">
                    <div
                ...
                <el-row class="import-row">
                    <el-link type="primary" class="download-template" @click="downloadXmindTemplate"
                        >{{ $t('test_track.case.import.download_template') }}
                    </el-link>
                </el-row>
                <el-row class="import-row">
...
export default {
    ...
    data() {
        return {
            ...
            isLoading: false,
            isUpdated: false,
            xMindIcon: require('../../../../../assets/xmind.jpg').default
        };
    },
    methods: {
        ...
        downloadXmindTemplate() {
            axios
                .get('/test/case/export/xmindTemplate', { responseType: 'blob' })
                .then(response => {
        ...
        upload(file) {
            ...
            this.result = this.$fileUpload(
                '/test/case/import/' + this.projectId + '/' + user.id,
                file.file,
                null,
                {},
                response => {
