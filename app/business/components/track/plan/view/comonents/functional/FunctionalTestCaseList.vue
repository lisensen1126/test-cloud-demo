    ...
    <el-table
      ...
      <template v-for="(item, index) in tableLabel">
        ...
        <el-table-column
          ...
          :filtered-value="priorityChecked"
          column-key="priority"
          min-width="100px"
          :key="index"
        ...
        <el-table-column
          ...
          :filtered-value="executorChecked"
          min-width="100px"
          :key="index"
          column-key="executor"
        ...
        <el-table-column
          ...
          :filtered-value="maintainerChecked"
          min-width="100px"
          :key="index"
...
export default {
  ...
  data() {
    return {
      ...
      priorityChecked: [], // 当前选中等级
      executorChecked: [], // 执行人选中
      maintainerChecked: [], // 负责人选中
      typeChecked: [], // 类型选中
      statusChecked: [], // 执行结果选中
      methodFilters: [
  ...
  methods: {
    ...
    filter(filters) {
      ...
      this.priorityChecked = filters?.priority || []
      this.executorChecked = filters?.executor || []
      this.maintainerChecked = filters?.maintainer || []
      this.typeChecked = filters?.type || []
      this.statusChecked = filters?.status || []
      this.initTableData();
    },
    sort(column) {
      // 每次只对一个字段排序
