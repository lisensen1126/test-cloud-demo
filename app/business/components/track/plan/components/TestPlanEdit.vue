        ...
        >
            ...
            <template v-slot:footer>
                <div class="dialog-footer">
                    ...
                    <el-button type="primary" @click="testPlanInfo" size="small">
...
export default {
    ...
    data() {
        const validateStartTime = (rule, value, callback) => {
            if (this.form.plannedEndTime && value >= this.form.plannedEndTime) {
        ...
        const validateEndTime = (rule, value, callback) => {
            if (this.form.plannedStartTime && value <= this.form.plannedStartTime) {
                callback(new Error('结束时间必须大于开始时间'));
                return;
            }
            this.$refs.planFrom.validateField('plannedStartTime');
            callback();
        };
        return {
            ...
            rules: {
                ...
                plannedStartTime: [{ validator: validateStartTime, trigger: 'blur' }],
                plannedEndTime: [{ validator: validateEndTime, trigger: 'blur' }],
            },
