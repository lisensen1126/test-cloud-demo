    ...
    <el-card class="table-card" v-loading="result.loading">
        ...
        >
            <template v-for="(item, index) in tableLabel">
                ...
                >
                    <template v-slot:default="scope">
                        <el-progress :percentage="calTestRate(scope)"></el-progress>
                    </template>
                </el-table-column>
                <el-table-column
            ...
            <el-table-column min-width="180" :label="$t('commons.operating')">
                ...
                <template v-slot:default="scope">
                    ...
                    <ms-table-operator-button
                        style="margin-left: 10px;border-width: thin;"
...
export default {
    ...
    methods: {
        ...
        calTestRate(scope) {
            let testRate = scope.row.testRate.toFixed(0);
            return Number.parseInt(testRate, 10);
        },
        customHeader() {
