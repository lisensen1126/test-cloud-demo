...
export default {
    ...
    methods: {
        open(data) {
            ...
            getTemplate('field/template/issue/get/relate/', this).then(template => {
        ...
        initEdit(data) {
            ...
            if (data) {
                ...
                if (data.id) {
                    ...
                    this.customFieldForm.memberLabel = data?.currentOwner || '';
                } else {
                    //copy
                    this.url = 'issues/add';
                }
        ...
        parseOldFields(param) {
            ...
            if (customFieldsStr) {
                ...
                customFields.forEach(item => {
                    ...
                    if (item.name === '处理人') {
                        param.currentOwner = this.customFieldForm?.memberLabel || '';
                    }
                });
            }
        },
