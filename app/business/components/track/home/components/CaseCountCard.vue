<template>
    ...
    >
        <div slot="header">
            <span class="title"> {{ $t('test_track.case.count') }} </span>
        </div>

        <el-container>
            <el-aside width="120px">
                <div class="data-picture">
                    <percentage-circle :value="trackCountData.allCaseCountNumber" />
                </div>
                <!-- <div class="data-picture">
          <el-progress type="circle" :width="100" :height="100" :percentage="trackCountData.allCaseCountNumber" color="#3385FF" :stroke-width="10"></el-progress>
        </div> -->
            ...
            <el-main style="padding: 5px;margin-top: 10px">
                <el-container>
                    ...
                    >
                        <el-container>
                            <el-aside width="50px">
                                {{ $t('test_track.case.percent') }}
                            </el-aside>
                            <el-main
                                style="padding: 0px 0px 0px 0px; line-height: 100px; text-align: left;margin-left:10px;"
                            >
                                <span class="count-number">
                                ...
                                <el-row>
                                    <el-col>
                                        <div class="review-main">
                                            <div class="review-color-orange"></div>
                                            <span class="default-property">
                                                {{ $t('test_track.case.noreview') }}
                                                {{ '\xa0\xa0' }}
                                                <el-link
                                                    type="info"
...
.data-picture /deep/ svg path:first-child {
    border-color: #f0f307;
}
