<template>
    <ms-container>
        <!-- <el-header height="0">
            <div style="float: right">
                ...
                <div v-else-if="tipsType === '2'">
                    😔 觉得MeterSphere不好用就来
                    <el-link
                        href="https://github.com/metersphere/metersphere/issues"
                        target="_blank"
                        style="color: black"
                        type="primary"
                        >https://github.com/metersphere/metersphere/issues
                    </el-link>
                    吐个槽吧！
                </div>
                <div v-else-if="tipsType === '3'">
                    😄 觉得MeterSphere好用就来
                    <el-link
                        href="https://github.com/metersphere/metersphere"
                        target="_blank"
                        style="color: black"
                        type="primary"
        ...
        <ms-main-container v-loading="result.loading">
            <div class="header-title">{{ $t('test_track.overview') }}</div>
            <el-row :gutter="10">
                <el-col :span="6">
                    <div class="square">
                        <case-count-card
    ...
    methods: {
        ...
        setBarOption(data) {
            ...
            let option = {
                ...
                legend: {
                    data: [
                        this.$t('api_test.home_page.功能用例数'),
                        this.$t('api_test.home_page.关联用例数'),
                    ],
                    orient: 'vertical',
                    right: '80',
                },
                series: [
                    {
                        name: this.$t('api_test.home_page.功能用例数'),
                        data: yAxis1,
                        type: 'bar',
                        barWidth: 80,
                        itemStyle: {
                    ...
                    {
                        name: this.$t('api_test.home_page.关联用例数'),
                        data: yAxis2,
                        type: 'bar',
                        barWidth: 80,
                        itemStyle: {
