...
export default {
    ...
    methods: {
        ...
        // getCollapseWidth() {
        //   const eles = document.getElementsByClassName('cuk-layout-aside')
        //   // 默認展開菜單寬度220px
        //   const collapseWidth = [...eles].length ? [...eles][0].offsetWidth : 220
        //   return this.offsetW !== -1 ? this.offsetW : collapseWidth
        // }
    },
};
</script>
...
.bottom-style .full-icon {
    right: 40px;
    top: 13px;
}

.right-style .full-icon {
    position: fixed;
    right: 10px;
    top: 58px;
}
