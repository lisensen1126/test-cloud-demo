    ...
    <el-menu menu-trigger="click" :default-active="$route.path" router class="setting">
        ...
        <el-submenu index="3" v-permission="['test_manager']" v-if="isCurrentWorkspaceUser">
            ...
            <el-submenu index="3-1">
                ...
                <el-menu-item
                    v-for="menu in workspaceTemplate"
                    :key="menu.index"
                    :index="menu.index"
                    class="setting-item"
...
const component =
    requireComponent.keys().length > 0 ? requireComponent('./license/LicenseMessage.vue') : null;
