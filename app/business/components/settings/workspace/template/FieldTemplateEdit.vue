            ...
            <el-main class="container">
                <el-scrollbar>
                    ...
                    >
                        ...
                        <el-form-item
                            :label="$t('table.selected_fields')"
                            class="filed-list"
                            :label-width="labelWidth"
                        >
                            <el-button type="primary" @click="relateField">{{
                                $t('custom_field.add_field')
                            }}</el-button>
...
export default {
    ...
    methods: {
        ...
        getRelateFields() {
            ...
            if (this.form.id) {
                this.result = this.$post('custom/field/template/list', condition, response => {
